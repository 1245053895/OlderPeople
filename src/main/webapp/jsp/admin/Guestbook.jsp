 ...
 <div class="search_style">
    ...
    <div class="Guestbook_list">
      ...
      <thead>
		 <tr>
          ...
          <th width="97px">商品id</th>
          <th width="97px">用户id</th>
          <th>评论内容</th>
          <th width="200">好评度</th>
          <%--<th width="70">状态</th>                --%>
          <th width="250">操作</th>
	...
	<tbody>
     ...
     <td><label><input type="checkbox" class="ace"><span class="lbl"></span></label></td>
        ...
        <a  onclick="member_edit('回复','member-add.html','4','','510')" title="回复"  href="javascript:;"  class="btn btn-xs btn-info" style="margin-left: 30px"><i class="fa fa-edit bigger-120"></i></a>
...
<div id="Guestbook" style="display:none">
 <div class="content_style">
  <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1">评论用户 </label>
       <div class="col-sm-9">胡海天堂</div>
	</div>
   <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 评论内容 </label>
