    ...
    <div class="sort_style">
        <div class="search_style">
            ...
            <ul class="search_content clearfix">
                <li><label class="l_f">退货订单</label><input name="" type="text" class="text_add" placeholder="订单编号" style=" width:250px"></li>
                <li><label class="l_f">时间</label><input class="inline laydate-icon" id="start" style=" margin-left:10px;height: 28px;"></li>
        ...
        <div class="sort_list">
            <table class="table table-striped table-bordered table-hover" id="sample-table">
                ...
                <tr>
                    ...
                    <th width="80px">ID</th>
                    <th width="80px">订单ID</th>
                    <th width="150px">商品名称</th>
                    <th width="200px">退货原因</th>
                    <th width="130px">申请退货时间</th>
                    <th width="130px">确认退货时间</th>
                ...
                <tr>
                    ...
                    <td>2</td>
                    <td>保暖内衣</td>
                    <td>不需要不需要不需要不需要不需要不需要不需要</td>
                    <td>2017.11.06</td>
                    <td>2017.11.06</td>
                    <td class="td-status"><span class="label label-success radius">未退货</span></td>
                    <td class="td-manage">
                        <a onClick="member_stop(this,'10001')"  href="javascript:;" title="退货"  class="btn btn-xs btn-success"><i class="fa fa-check  bigger-120"></i></a>
...
<script type="text/javascript">
    ...
    function member_stop(obj,id){
        layer.confirm('确认要退货吗？',{icon:0,},function(index){
            ...
            $(obj).parents("tr").find(".td-status").html('<span class="label label-defaunt radius">已退货</span>');
            $(obj).remove();
            layer.msg('确认退货!',{icon: 5,time:1000});
        });
    }
    /*广告图片-删除*/
