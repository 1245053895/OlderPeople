...
<body style="margin: 15px;">
    <div class="search_style">
        ...
        <ul class="search_content clearfix">
            <li><label class="l_f">物流方式</label><input name="" type="text" class="text_add" placeholder="物流编号、物流名称" style=" width:250px"></li>
            <li><label class="l_f">添加时间</label><input name="" class="inline laydate-icon" id="start" style=" margin-left:10px;height: 27px;"></li>
    ...
    <div class="Guestbook_list">
        <table class="table table-striped table-bordered table-hover" id="sample-table">
            ...
            <tr>
                ...
                <td>1</td>
                <td width="200px;">顺丰快递</td>
                <td><span class="ad_img"><img src="images/sfkd.png"  width="100%" height="100%"/></span></td>
...
<div id="add_ads_style"  style="display:none">
 ...
 <ul>
  ...
  <li><label class="label_name">物流名称</label>
      <span class="cont_style"><input name="物流名称" type="text" placeholder="请输入物流名称" class="col-xs-10 col-sm-5"></span>
  </li>
