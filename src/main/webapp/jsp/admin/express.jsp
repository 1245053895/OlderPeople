...
<div data-mohe-type="kuaidi_new" class="g-mohe " id="mohe-kuaidi_new" style="margin: 0px auto;width: 800px">
...
<script>
    window.onload = function(){
        ...
        $("ul").append("<li style='margin-left:-100px;margin-top:50px;height: 120px;width: 100%;border-top: 1px #d3d3d3 solid'></li>");
    }
</script>
