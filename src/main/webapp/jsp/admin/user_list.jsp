		...
		<thead>
		 <tr>
                <th width="25">
                 ...
                 <th width="250px" class="sorting_disabled" rowspan="1" colspan="1" aria-label="用户名" style="width: 170px;">用户名</th>
                 <th width="100px" class="sorting_disabled" rowspan="1" colspan="1" aria-label="密码" style="width: 63px;">密码</th>
                 <th width="100px" class="sorting_disabled" rowspan="1" colspan="1" aria-label="性别" style="width: 63px;">性别</th>
                 <th width="100px" class="sorting_disabled" rowspan="1" colspan="1" aria-label="真实姓名" style="width: 63px;">真实姓名</th>
                 <th width="100px" class="sorting_disabled" rowspan="1" colspan="1" aria-label="电话" style="width: 63px;">电话</th>
                 <th width="100px" class="sorting_disabled" rowspan="1" colspan="1" aria-label="出生年月" style="width: 63px;">出生年月</th>
                 <th width="100px" class="sorting_disabled" rowspan="1" colspan="1" aria-label="收货地址" style="width: 63px;">收货地址</th>
                 <th width="100px" rowspan="1" colspan="1" aria-label="e-mail" style="width: 63px;">e-mail</th>
                 <th width="100px" class="sorting_disabled" rowspan="1" colspan="1" aria-label="邮编" style="width: 63px;">邮编</th>
                 <th width="100px" class="sorting_disabled" rowspan="1" colspan="1" aria-label="注册时间" style="width: 63px;">注册时间</th>
                 <th width="100px" class="sorting_disabled" rowspan="1" colspan="1" aria-label="状态" style="width: 63px;">状态</th>
                 <th width="200px" class="sorting_disabled" rowspan="1" colspan="1" aria-label="操作" style="width: 143px;">操作</th>
         </tr>
		</thead>
           <tbody>
...
<div class="add_menber" id="add_menber_style" style="display:none;z-index: 19891022; width: 700px;top: 0px;left: 229.5px;">
    <ul class=" page-content">
     ...
     <li><label class="label_name">电话：</label><span class="add_name"><input name="电话" type="text"  class="text_add"/></span><div class="prompt r_f"></div></li>
     <li><label class="label_name">出生年月：</label><span class="add_name"><input name="出生年月" type="text"  class="text_add"/></span><div class="prompt r_f"></div></li>
