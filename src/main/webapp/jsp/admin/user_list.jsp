            ...
            <div class="search_style">
                ...
                <form id="QueryUserConfuse" action="${pageContext.request.contextPath}/QueryUserConfuse.action"
                    ...
                    <ul class="search_content clearfix">
                        <li><label class="l_f">用户名称</label><input name="sqlString" type="text"
...
<div class="add_menber"id="add_menber_style"
    ...
    <form id="insertSelective" action="${pageContext.request.contextPath}/insertSelective.action" method="post">
        <ul class=" page-content">
         ...
         <label><input name="usersex" type="radio" checked="checked" class="ace"><span class="lbl">男</span></label>&nbsp;&nbsp;&nbsp;
         <label><input name="usersex" type="radio" class="ace"><span class="lbl">女</span></label>&nbsp;&nbsp;&nbsp;
         <label><input name="usersex" type="radio" class="ace"><span class="lbl">保密</span></label>
         </span>
                <div class="prompt r_f"></div>
            </li>
...
--%>
        ...
        <%--<li> <input class="btn btn-primary radius" type="submit" id="Add_Administrator" value="&nbsp;&nbsp;提交&nbsp;&nbsp;" ></li>--%>
    </form>
</div>
</body>
</html>
