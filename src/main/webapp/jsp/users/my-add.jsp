...
<div style="width: 100%;">
	<div class="center" style="background:#fff;margin: -15px auto; width: 1050px">
		<div class="pay_lc1" style="margin: 0px!important;">
			<span class="sp01">确认订单</span>
			<span class="sp02">在线支付</span>
			<span class="sp03">支付成功</span>
		</div>
		<!--收货地址body部分开始-->
		<div class="border_top_cart" style="margin: 0px!important;">
			<script type="text/javascript">
				var checkoutConfig={
					addressMatch:'common',
